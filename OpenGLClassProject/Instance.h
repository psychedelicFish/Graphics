...
public:
	Instance(glm::mat4 transform, Mesh* mesh, aie::ShaderProgram* shader) : transform{ transform }, mesh{ mesh }, shader{ shader }{}
	
	Instance(Mesh* mesh, aie::ShaderProgram* shader) : mesh {mesh}, shader{shader}{
		MakeTransform(glm::vec3(0), glm::vec3(0), glm::vec3(1));
	}
	
	Instance(glm::vec3 position, glm::vec3 rotation, glm::vec3 scale, Mesh* mesh, aie::ShaderProgram* shader):  mesh{ mesh }, shader{ shader } {
